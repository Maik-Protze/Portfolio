...
# Generates resume.pdf from resume.html using wkhtmltopdf or headless Chrome/Chromium.
# Usage: ./scripts/generate_pdf.sh

ROOT_DIR="$(cd "$(dirname "$0")/.." && pwd)"
HTML="$ROOT_DIR/resume.html"
OUT="$ROOT_DIR/resume.pdf"
